...
public class LotkaVolterra {
    private static final Logger LOG = LogManager.getLogger(LotkaVolterra.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ParameterPanel parameterPanel = description
                    .createParameterPanel(sys);
            ...
            dim.width /= 2;
            dim.height /= 2;
            frame.setBounds(dim.width / 2, dim.height / 2, dim.width,
                    dim.height);
            ...
            LOG.error("Ausnahme in main", e);
        }

    }

    protected static SimulationFabric integralX() {
        SimulationFabric description = new SimulationFabric(
                "Integral von f(x) := x");
        ...
        description
                .addShowResults(new ShowResultsDescription("Result",
                        "simulation.results.ShowInPanel", "id", "integral",
                        "Integral"));
        return description;
    }
    ...
    protected static SimulationFabric lotkaVolterra() {
        ...
        description.addNodeDescription("beute",
                "simulation.nodes.IntegralWithStartValue").setTitle("Beute");
        description.addNodeDescription("raeuber",
                "simulation.nodes.IntegralWithStartValue").setTitle("Räuber");

        description.addNodeDescription("cmr", "simulation.nodes.CXYMult")
                .setTitle("Vermehrung Räuber");
        description.addNodeDescription("cmb", "simulation.nodes.CXYMult")
                .setTitle("Getötete Beute");

        description.addNodeDescription("mr", "simulation.nodes.CXMult")
                .setTitle("Todesrate Räuber");
        description.addNodeDescription("mb", "simulation.nodes.CXMult")
                .setTitle("Vermehrung Beute");
        ...
        ShowResultsDescription showDescription = new ShowResultsDescription(
                "Räuber&Beute", "simulation.results.PositivAxes");
